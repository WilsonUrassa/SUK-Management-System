...
export default async function Operations({searchParams}:{searchParams:Promise<{org?:string}>}) {
 ...
 if(!o)return <main className="main"><WorkspaceNav org={o.id}/><div className="card"><h1 className="title">Operations</h1><Link className="button" href="/onboarding">Create organization</Link></div></main>;
