...
export default async function Reports({searchParams}:{searchParams:Promise<{org?:string}>}) {
 ...
 if(!o)return <main className="main"><WorkspaceNav org={o.id}/><div className="card"><h1 className="title">Reports</h1><Link className="button" href="/onboarding">Create organization</Link></div></main>;
